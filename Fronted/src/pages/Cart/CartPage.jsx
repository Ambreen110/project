  ...
  return (
    showModal && (
      <div className="fixed inset-0 z-50 bg-black bg-opacity-75 flex justify-center items-center">
        <div className="flex-col flex items-center bg-white dark:bg-black gap-8 p-10 text-black dark:text-white font-normal uppercase text-sm">
          <ToastContainer />
          ...
          <div className="cart-items-container max-h-80 overflow-y-auto">
